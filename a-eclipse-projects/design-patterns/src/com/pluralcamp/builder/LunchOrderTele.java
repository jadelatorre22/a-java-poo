...
//	public LunchOrderTele(String bread, String dressing, String meat) {
//		this.bread = bread;
//		this.dressing = dressing;
//		this.meat = meat;
//	}
	...
	public LunchOrderTele(String meat) {
		this.meat = meat;
	...
	public String toString() {
		...
		return clase + ": " + "bread = " + this.getBread() + ", " 
				+ "condiments = "  + this.getCondiments() + ", " + "dressing = "
				+ this.getDressing() + ", " + "meat = " + this.getMeat();
	}
}
